...
export const ninetyDayPhases: NinetyDayPhase[] = [
  {
    range: "0〜30日",
    title: "現状を知る",
    items: ["Analytics / Search Console", "予約・相談データ", "受け入れ体制", "基準値"],
    detail: ["予約データ", "相談データ", "流入元", "キャンセル"],
    gate: "本当のボトルネックはどこか？",
  },
  {
    range: "31〜60日",
    title: "判断しやすくする",
    items: ["悩み別導線", "価格情報の整理", "Selective Beauty Map", "Consultation Brief"],
    detail: ["関連コンテンツ", "計測設計"],
    gate: "新しい導線は使われているか？",
  },
  {
