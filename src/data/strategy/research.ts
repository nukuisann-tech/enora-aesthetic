...
export const researchItems: ResearchItem[] = [
  ...
  },
  {
    ...
    whyItMatters:
      "価格・リスク情報を「隠さない」設計は任意のUX判断ではなく、自由診療で情報提供が求められる領域と重なる。",
...
export const researchLimitation =
  "上記の外部調査は、美容医療市場全体の傾向を理解するための参考情報であり、ÉNORAの想定顧客(30〜45歳・価格感度が低〜中程度の女性)を直接代表するものではない。実案件では、対象読者層に近いセグメントでの一次調査、または実施設の相談データの分析を優先する。";
